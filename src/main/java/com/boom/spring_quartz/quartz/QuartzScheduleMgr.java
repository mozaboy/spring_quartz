package com.boom.spring_quartz.quartz;
...
//    }  
    ...
    public static void setCron(String cronTime, String jobName) throws SchedulerException{
    	Trigger trigger = TriggerBuilder.newTrigger().forJob(jobName).withSchedule(CronScheduleBuilder.cronSchedule(cronTime)).build();
